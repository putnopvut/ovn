...
OVS_OVSDB_DOT = $(run_python) $(srcdir)/ovs/ovsdb/ovsdb-dot.in

EXTRA_DIST += ovs/ovsdb/_server.ovsschema
CLEANFILES += ovs/ovsdb/_server.ovsschema.inc
ovs/ovsdb/ovsdb-server.$(OBJEXT): ovs/ovsdb/_server.ovsschema.inc
ovs/ovsdb/_server.ovsschema.inc: ovs/ovsdb/_server.ovsschema $(srcdir)/build-aux/text2c
